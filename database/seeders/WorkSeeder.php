    ...
    public function run()
    {
        $main_data = [
            [
                ...
                'quote'  => 'Земельный банк компании насчитывает порядка 27 000 гектаров и расположен единым массивом на территории трех районов Курской области. Мы выращиваем: озимую и яровую пшеницу овес, ячмень, подсолнечник, кукурузу, сою.',
                'img' => 'rast.webp',
            ...
            [
                ...
                'quote'  => 'Полный цикл производства от выращивания кормовой базы до поставок готовой продукции. Наша компания располагает стадом 3 788 голов крупного рогатого скота фуражных и мясных пород',
                'img' => 'giv.webp',
