    ...
    public function run()
    {
        $main_data = [
            [
                ...
                'value1' => "26 000+ Га",
                'comment1' => "Земли в Центральном Черноземье",
                'value2' => "3291 +",
                'comment2' => "Поголовье КРС",
                'value3' => "40 000 тонн",
                'comment3' => "Элеватор силосного типа",
                'value4' => "175",
                'comment4' => "Единиц сельхозтехники",
            ],
            ...
            [
                ...
                'value4' => "50 +",
                'comment4' => "Ульев на собственной пасеке",
            ],
            ...
            [
                'title' => "Овцеводство",
                'img' => "bn5.webp",
                'subtitle' => "Устойчивый рост поголовья <br/> овец куйбашевской пород",
                'value1' => "900 +",
