    ...
    <section class="contacts_text work_np_page">
        <div class="_container">
            ...
            <div class="text_styles">
                <p>Земельный банк компании насчитывает более 26 000 гектаров и расположен на территории трех районов Курской области.</p>
                ...
                <p>Главная задача растениеводства — подготовка качественных кормов для собственного поголовья скота, а также реализация продукции на продажу. Компания реализует план развития растениеводства, который подразумевает неуклонное повышение урожайности всех видов возделываемых культур.</p>
            </div>
            ...
            <div class="slider-bg__inner">
                ...
                <div class="slider-bg__column">
                    <div class="slider-bg__card slider-bg__card_01">
                        <h3 class="slider-bg__card-title">26 000+ Га</h3>
                ...
                <div class="slider-bg__column">
                    <div class="slider-bg__card slider-bg__card_03">
                        <h3 class="slider-bg__card-title">62,4 ц/га</h3>
                        <p class="slider-bg__card-subtitle">
                            Урожайность пшеницы.
                        </p>
                    </div>
            ...
            <div class="swiper_obj swiper_obj_product mb_30">
